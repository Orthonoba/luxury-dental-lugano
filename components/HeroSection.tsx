...
export default function HeroSection() {
  return (
    <section className="relative min-h-screen flex flex-col items-center justify-center overflow-hidden">
      {/* Background */}
      <div className="absolute inset-0 bg-gradient-to-br from-[#0a0d06] via-[#141a0a] to-[#1e2810]" />

      {/* Ambient orbs */}
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute top-1/4 -left-20 w-[500px] h-[500px] rounded-full bg-olive/8 blur-[120px]" />
        <div className="absolute bottom-1/4 -right-20 w-[400px] h-[400px] rounded-full bg-gold/8 blur-[100px]" />
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[300px] h-[300px] rounded-full bg-beige/4 blur-[80px]" />
      </div>
      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto px-6 lg:px-8 text-center">
        ...
        >
          <a
            href="#contact"
            className="group px-8 py-4 bg-gold text-white text-[11px] tracking-[0.25em] uppercase font-semibold rounded-full hover:bg-gold-light transition-all duration-300 hover:shadow-2xl hover:shadow-gold/30 hover:-translate-y-0.5"
          >
            Book Consultation
          </a>
          <a
