  ...
  return (
    ...
    >
      <nav className="max-w-7xl mx-auto px-6 lg:px-8 h-20 flex items-center justify-between">
        ...
        <a
          href="/contact"
          className="hidden lg:inline-flex items-center px-6 py-2.5 bg-olive text-white text-[11px] tracking-[0.2em] uppercase font-medium rounded-full hover:bg-olive-light transition-all duration-300 hover:shadow-lg hover:shadow-olive/25 hover:-translate-y-px"
        >
          Book Now
        </a>
          ...
          >
            <div className="max-w-7xl mx-auto px-6 py-8 flex flex-col gap-5">
              ...
              <a
                href="/contact"
                onClick={() => setMenuOpen(false)}
                className="mt-2 text-center py-3 px-6 bg-olive text-white text-[11px] tracking-[0.2em] uppercase font-medium rounded-full hover:bg-olive-light transition-colors"
              >
                Book Now
              </a>
            </div>
